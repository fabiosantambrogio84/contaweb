...
<s:form action="editDDT_pagamento" validate="true" method="POST" theme="css_xhtml">
	<s:hidden name="id" />
    ...
    <s:textarea labelposition="left" label="Note" name="pagamentoEseguito.notes" required="false" cols="35" rows="3" cssClass="testo"></s:textarea>
