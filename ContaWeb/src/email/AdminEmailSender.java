...
public class AdminEmailSender extends AbstractEmailSender{
    ...
    public void sendFattureReport(List<FatturaEmailResult> fattureResults) throws Exception{
        ...
        try{
            ...
            long executionTs = nowZdt.toInstant().toEpochMilli();
            ...
            if(fattureResults != null && !fattureResults.isEmpty()){
                content = "In allegato i risultati dell'operazione <b>'Spedizione Fatture "+emailOrPec+"'</b>.<br/> Data esecuzione: " + nowZdt.format(formatter);
                ...
                content = "'<b>Spedizione Fatture '"+emailOrPec+"</b>: nessuna fattura da inviare. Data esecuzione: " + nowZdt.format(formatter);
            }
