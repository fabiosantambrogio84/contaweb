            ...
            while (itr.hasNext()) {
                ...
                if (map.containsKey(fattura.getIdCliente().intValue())) {
                    ...
                    for (Object obj : aliquote) {
                        ...
                        if (index == 1) {
                            riga.setIva1(new BigDecimal(iva.getValore()));
                            riga.setImponibile1(imponibile);
                            riga.setImposta1(imposta);

                        } else if (index == 2) {
                            riga.setIva2(new BigDecimal(iva.getValore()));
                            riga.setImponibile2(imponibile);
                            riga.setImposta2(imposta);
                        } else if (index == 3) {
                            riga.setIva3(new BigDecimal(iva.getValore()));
