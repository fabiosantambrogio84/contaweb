...
public class Listini extends DataAccessObject {
    ...
    private static final long serialVersionUID = 1024536781045342625L;
    ...
    public Collection<Listino> getListiniFiltrati(Integer id) throws DataAccessException {
        PersistenceBroker broker = null;
        List<Listino> results = null;
        try {
    ...
    public List<Cliente> getClientiByListino(Integer idFornitore, Integer idListino, String rs, Integer startRow, Integer endRow)
        ...
        elementClass = ListinoAssociato.class;
        if (idFornitore != null)
            getCriteria().addColumnEqualTo("idFornitore", idFornitore);
        if (idListino != null)
            getCriteria().addColumnEqualTo("idListino", idListino);
    ...
    @SuppressWarnings("unchecked")
    public Integer getCountClientiByListino(Integer idFornitore, Integer idListino, String rs) throws DataAccessException {
    ...
    public Collection<Prezzo> getPrezziByListino(Integer idListino) throws DataAccessException {
        Prezzi prezziDao = new Prezzi();
        return prezziDao.getPrezziByListino(idListino);
    }
