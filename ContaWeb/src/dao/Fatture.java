...
import applet.applet.DDTApplet;
  ...
  implements Runnable
{
  ...
  public Collection<?> getFattureNoPEC(java.util.Date dataInizio, java.util.Date dataFine) throws DataAccessException {
    getCriteria().addBetween("data", dataInizio, dataFine);
