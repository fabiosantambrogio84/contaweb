            ...
            buttonModifica.addActionListener(new java.awt.event.ActionListener() {
                ...
                public void actionPerformed(java.awt.event.ActionEvent e) {
                    try {
                        ...
                        JOptionPane.showMessageDialog(contentPane, "Il DDT e' stato aggiornato con successo", "Successo",
            ...
            buttonSSN.addActionListener(new java.awt.event.ActionListener() {
                ...
                public void actionPerformed(java.awt.event.ActionEvent e) {
                    try {
                        ...
                        JOptionPane.showMessageDialog(getPanelBottoni(), "Il DDT è stato salvato con successo", "Successo",
                                JOptionPane.INFORMATION_MESSAGE);
                        setModalitaInserimentoDDT();
                        stampaDDT(idDDT);
                    } catch (Exception e1) {
            ...
            buttonSN.addActionListener(new java.awt.event.ActionListener() {
                ...
                public void actionPerformed(java.awt.event.ActionEvent e) {
                    try {
                        ...
                        JOptionPane.showMessageDialog(contentPane, "Il DDT è stato salvato con successo", "Successo",
                                JOptionPane.INFORMATION_MESSAGE);
                        setModalitaInserimentoDDT();
                    } catch (Exception e1) {
                        JOptionPane.showMessageDialog(contentPane, e1.getMessage(), "Attenzione", JOptionPane.ERROR_MESSAGE);
