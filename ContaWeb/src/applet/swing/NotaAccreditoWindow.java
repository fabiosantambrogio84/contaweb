...
public class NotaAccreditoWindow {
    ...
    private void editTable() {
        ...
        if (selectedRow != -1) {
            ...
            for (int i = 0; i < cmbIva.getItemCount(); ++i)
                if (iva == new BigDecimal(((Iva) cmbIva.getItemAt(i)).getValore()))
    ...
    private JPanel getPanelSpedizione() {
        if (panelCausale == null) {
            ...
            panelCausale.setBorder(BorderFactory.createTitledBorder(null, "Descrizione sconto", TitledBorder.DEFAULT_JUSTIFICATION,
                    TitledBorder.DEFAULT_POSITION, new Font("Tahoma", Font.PLAIN, 11), new Color(0, 70, 213)));
            ...
            buttonModifica.addActionListener(new java.awt.event.ActionListener() {
                ...
                public void actionPerformed(java.awt.event.ActionEvent e) {
                    try {
                        ...
                        JOptionPane.showMessageDialog(contentPane, "La Nota Accredito � stato aggiornato con successo", "Successo",
            ...
            buttonSN.addActionListener(new java.awt.event.ActionListener() {
                ...
                public void actionPerformed(java.awt.event.ActionEvent e) {
                    try {
                        NotaAccredito ddt = getNotaAccredito();
                        new DbConnector().saveNotaAccredito(ddt);
                        JOptionPane.showMessageDialog(contentPane, "La Nota di Accredito � stato salvato con successo", "Successo",
                                JOptionPane.INFORMATION_MESSAGE);
                        setModalitaInserimentoDDT();
                    } catch (Exception e1) {
                        JOptionPane.showMessageDialog(contentPane, e1.getMessage(), "Attenzione", JOptionPane.ERROR_MESSAGE);
